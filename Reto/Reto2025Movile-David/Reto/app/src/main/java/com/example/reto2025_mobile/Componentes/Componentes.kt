...
fun DetailTopBar(navController: NavController, titulo: String) {
    ...
    TopAppBar(
        ...
        colors = TopAppBarDefaults.topAppBarColors(
            containerColor = Color(0xFF7A9B23),
            titleContentColor = Color.White
        ),
        actions = {
            Box {
...
fun ActividadesTopAppBar(navController: NavController) {
    ...
    TopAppBar(
        ...
        colors = TopAppBarDefaults.topAppBarColors(
            containerColor = Color(0xFFA0C94E),
            titleContentColor = Color.White
        ),
        actions = {
            Box {
...
fun HomeAppBar(navController: NavController) {
    ...
    TopAppBar(
        ...
        colors = TopAppBarDefaults.topAppBarColors(
            containerColor = Color(0xFF8DBB38),
            titleContentColor = Color.White
        ),
        actions = {
            Box {
                IconButton(onClick = { showlogout = true }) {
                    Icon(
                        ...
                        tint = Color.White // Asegúrate de que el icono de logout sea blanco
                    )
                    if (showlogout) {
                        AlertDialog(
                            onDismissRequest = { },
        ...
        bar_items.forEach { item ->
            ...
            NavigationBarItem(
                ...
                colors = NavigationBarItemDefaults.colors(
                    ...
                    // Aquí puedes definir los colores para el fondo seleccionado y no seleccionado
                    indicatorColor = if (clicked) Color(0xFFFFFFFF) else Color.Transparent
                )
            )
        }
    }
...
fun Incidencias(onDismiss: () -> Unit) {
    ...
    AlertDialog(
        ...
        containerColor = Color(0xFF77A832),
        shape = RoundedCornerShape(16.dp), // Bordes redondeados para un aspecto moderno
        title = {
            Text(
        ...
        text = {
            Column {
                TextField(
                    ...
                    placeholder = { Text("Escribe tu incidencia aquí...") },
                    modifier = Modifier
                        .fillMaxWidth()
...
fun Mapa(onDismiss: () -> Unit) {
    AlertDialog(
        modifier = Modifier
            ...
            .size(400.dp),
        onDismissRequest = onDismiss,
        containerColor = Color(0xFF99C24D),
        confirmButton = {
...
fun ActivityCalendarApp(
    ...
    // Estado para mostrar el diálogo de detalles
    ...
    Column(modifier = Modifier
        ...
        Box(
            modifier = Modifier
                .weight(1f) // Asigna peso al calendario
        ) {
                ...
                dayContent = { dayState ->
                    MyDayContentWithActivities(
                        ...
                        onClick = {
                            ...
                            showDialog = true // Mostrar el diálogo de detalles
                        }
                    )
                }
            )
        ...
        // Mostrar el diálogo con información sobre el día seleccionado
        if (showDialog) {
    ...
    Dialog(onDismissRequest = onDismiss) {
        Card(
            modifier = Modifier
                .padding(5.dp),
            shape = RoundedCornerShape(12.dp),
            colors = CardDefaults.cardColors(containerColor = Color(0xFF99C24D)),
        ) {
            Box(
                modifier = Modifier
                    .padding(10.dp),
